 ...
 * @version 1.0
 */
class EstudianteAsignaturaComparador implements Comparator {
	...
	info1 = (InfoAcad)o1;
	info2 = (InfoAcad)o2;
	resultado = info1.obtenerEstudiante().compareTo(info2.obtenerEstudiante());
	if ( resultado != 0 )
	    return resultado;
	else
	    return info1.obtenerAsignacion().compareTo(info2.obtenerAsignacion());
    }
}